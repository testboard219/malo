...
<title>Eliteplox| Your Trusted Bitcoin  Mining and Investment Company</title>
...
<ul class="topheader">
	<li class="logo">
		<div class="bodycontainer">
			...
			<a href="index.html">
			<img src="lexaprime2.png"  style="width:100px;height:80px; border-top-left-radius:20px;border-bottom-right-radius:20px;" title="Eliteplox| Your Trusted Bitcoin  Mining and Investment Company"/>
...
<div class="area">
	...
	<form action="#" method="POST">
        ...
        <input type="mail" placeholder="Email"  name="email" value="" style="width:100%" class="margintb round"></input>
        	<input type="password" placeholder="Password" required name="password1" style="width:100%" class="margintb round"></input>
        	...
        	<input type="submit" value="Login" name="login" class="btn round default"><br><br>
           <br><br>
	</form>
