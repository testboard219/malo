...
<div class="area">
	<div class="bodycontainer">
		<h1 class="tlt text-white" style="margin: 20px 0;">Email <span class="text-default">Verification</span></h1>
		<div class="banner-title">
           <span class="decor-equal"></span>
		</div>
		<div  style="margin: 20px 0;">
			<a href="index.html">HOME</a> / Mail verification
		</div>
	</div>
	...
	<form action="#" method="POST">
    	<div class="title_container">
			  <h4>Code Authentication</h4>
			  <span class="decor_default"></span>

		</div>
        <input type="hidden" name="email" value="<?php echo $_GET['email']; ?>" required>
                    <input type="text" placeholder="Enter verification code" required name="verification_code" value="" style="width:100%" class="margintb round">

			
                    <input type="submit" name="verify_email" value="Verify Email"><br><br>
           <br><br>
	</form>
    ...
    <div class="bodycontainer">
        <div class="row">
            ...
            <div class="padding">
				...
				<a href="tel:+1(347) 850-7160">+1(347) 850-7160</a>
				<ul>
