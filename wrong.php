...
function del(id)
{
  ...
  {
      window.location.href='https://eliteplox.com/faqs?set=del&del=' + id;
  }
}
</script>
<script language="JavaScript" type="text/javascript">
function del(id)
{
  if (confirm("Are you sure you want to delete this FAQ"))
  {
      window.location.href='https://eliteplox.com/admin?n=faq&set=del&del=' + id;
  }
}
</script>
...
<h1 style="color:red;">wrong credentials provided kindly try again by providing your right credentials</h1>
        ...
        <div class="row">
            ...
            <div class="padding">
				...
				<a href="mailto://support@Primeplox.com"><h3>support@Primeplox.com</h3></a>
					<a href="tel:+1(347)850-7160"></a>+1(347)850-7160</a>
				<ul>
